...
static bool ui_menu_about_nav_callback(uint8_t page,
...
static void ui_menu_about(void) {
    nbgl_useCaseSettings("Hedera Stax Application", 0, 1, false, ui_idle_nbgl,
                         ui_menu_about_nav_callback, NULL);
}
...
static void ui_idle_nbgl(void) {
    nbgl_useCaseHome("Hedera", &C_icon_hedera_64x64, NULL, false, ui_menu_about,
                     quit_app_callback);
}
